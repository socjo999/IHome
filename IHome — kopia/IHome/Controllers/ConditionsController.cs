...
namespace IHome.Controllers
{
    public class ConditionsController : Controller
    {
        ...
        public ConditionsController(EFCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,State,ConditionString,FillCondition")] Condition condition)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,State,ConditionString,FillCondition")] Condition condition)
        {
            if (id != condition.ID)
            {
                return NotFound();
